...
const JP_SURNAMES = (() => {
  const list = [
    ...
    '蕪田','蕪野',
    // 追加分（海老根ほか）
    '海老根','海老沢','海老名','海老原','海老江','海老澤',
    '海野','海田','海本','海山','海川','海島','海村','海崎','海原','海岸','海道','海部',
    '蝦名','蝦沢',
    '老沼','老田',
    '鰐渕','鰐川',
    '鱒渕','鮎川','鮎田','鮎沢','鮎澤',
    ...
    '鱈田',
    // え行
    '江尻','江島','江崎','江藤','江口','江田','江川','江村','江野','江本','江原','江波','江連','江頭','江幡','江守','江森','江見','江面',
    '榎本','榎田','榎原','榎園','榎並','榎並',
    '遠藤','遠山','遠田','遠野','遠川','遠島','遠崎','遠村','遠本','遠江','遠原','遠坂',
    '越智','越田','越野','越川','越村','越本','越後','越前','越中',
    '衛藤','衛門',
    // あ行追加
    '阿久津','阿久根','阿久澤','阿久沢',
    '阿武','阿部川','阿波根','阿波野','阿波田',
    ...
    '阿知波','阿知田',
    '阿南','阿蘇',
    '芦沢','芦田','芦野','芦川','芦原','芦村','芦本','芦崎','芦塚','芦名',
    '葦原','葦田',
    '安孫子','安達','安田','安藤','安倍','安部','安野','安川','安本','安原','安村','安西','安東','安岡','安楽','安芸','安房',
    '飯田','飯野','飯島','飯塚','飯川','飯村','飯本','飯星','飯沢','飯澤','飯尾','飯高','飯倉',
    '飯豊','飯坂','飯岡','飯泉','飯牟礼',
    '粟田','粟野','粟原','粟村','粟川','粟島','粟津','粟生','粟田口',
    '天野','天田','天川','天本','天村','天原','天崎','天海','天羽','天満','天神','天沼','天津','天谷','天辰','天草',
    '雨宮','雨野','雨田','雨川',
    '綾田','綾野','綾川','綾部','綾村','綾本',
    '鮎田','鮎野',
    // い行追加
    '池上','池端','池辺','池谷','池永','池宮','池見','池添','池浦','池部','池内','池原','池本',
    '井上','井田','井野','井川','井村','井本','井原','井口','井関','井出','井深','井筒','井坂','井沢','井澤','井岡','井崎',
    '石上','石坂','石崎','石川','石田','石野','石原','石村','石本','石橋','石黒','石井','石塚','石神','石垣','石倉','石切','石津','石沢','石澤','石丸','石谷','石峠','石渡',
    '一瀬','一色','一条','一戸','一宮','一ノ瀬','一迫','一関',
    '入江','入野','入田','入川','入村','入本','入原','入崎',
    '岩佐','岩崎','岩田','岩野','岩川','岩村','岩本','岩原','岩橋','岩井','岩切','岩谷','岩津','岩沢','岩澤','岩岡','岩永','岩月','岩坂','岩渕','岩淵',
    '伊賀','伊勢','伊豆','伊那','伊万里',
    '井手','井手口',
    // う行追加
    '上田','上野','上川','上村','上本','上原','上島','上崎','上橋','上坂','上谷','上月','上沢','上澤','上杉','上條','上条','上甲',
    '植田','植野','植川','植村','植本','植原','植島','植崎','植木','植松',
    '宇田','宇野','宇川','宇村','宇本','宇原','宇島','宇崎','宇佐','宇津','宇沢','宇澤',
    '宇都宮','宇治','宇和島',
    '内田','内野','内川','内村','内本','内原','内島','内崎','内山','内海','内藤',
    '浦田','浦野','浦川','浦村','浦本','浦原','浦島','浦崎','浦野','浦山','浦谷',
    '梅田','梅野','梅川','梅村','梅本','梅原','梅島','梅崎','梅沢','梅澤','梅津',
    '臼田','臼野','臼川','臼井',
    '牛田','牛野','牛川','牛島','牛崎','牛込','牛尾',
    '鵜飼','鵜野','鵜川','鵜沢',
    // お行追加
    '大石','大村','大野','大田','大川','大本','大原','大島','大崎','大橋','大塚','大谷','大澤','大沢','大久保','大西','大林','大森','大門','大場','大江','大曲','大須賀','大須',
    '小石','小川','小野','小田','小村','小本','小原','小島','小崎','小橋','小塚','小谷','小沢','小澤','小久保','小西','小林','小森','小門','小場','小江',
    '岡田','岡野','岡川','岡村','岡本','岡原','岡島','岡崎','岡橋','岡谷','岡沢','岡澤','岡津','岡部','岡上','岡下','岡西','岡東',
    '荻野','荻田','荻川','荻村','荻本','荻原','荻島','荻崎','荻沢','荻澤',
    '奥田','奥野','奥川','奥村','奥本','奥原','奥島','奥崎','奥橋','奥谷','奥沢','奥澤','奥津','奥山','奥西',
    '小澤','小笠原','小笠','小鹿','小熊','小倉','小宮','小宮山',
    '尾田','尾野','尾川','尾村','尾本','尾原','尾島','尾崎','尾関','尾道','尾上','尾形',
    '織田','織野','織川','織村','織本','織原',
    '鬼頭','鬼塚','鬼沢','鬼澤','鬼川','鬼野',
    '御田','御野','御川','御村','御本','御原',
    '小見','小峰','小峯','小貫','小俣','小針','小柳','小室','小宮',
    // か行追加
    '加藤','加納','加賀','加島','加野','加田','加川','加村','加本','加原','加崎','加茂',
    '鹿田','鹿野','鹿川','鹿村','鹿本','鹿原','鹿島','鹿崎','鹿沼','鹿角','鹿追',
    '春日','春野','春田','春川','春村','春本','春原','春島','春崎','春沢','春澤',
    '金田','金野','金川','金村','金本','金原','金島','金崎','金沢','金澤','金津','金谷','金子','金山','金光','金岡','金城','金久',
    '鎌田','鎌野','鎌川','鎌村','鎌本','鎌原','鎌島','鎌崎',
    '釜田','釜野','釜川','釜村','釜本','釜原','釜島','釜崎',
    '上月','上甲','上條','上泉','上遠野',
    '河野','河田','河川','河村','河本','河原','河島','河崎','河橋','河谷','河沢','河澤','河津','河上','河西','河東','河内',
    '川島','川崎','川原','川口','川上','川下','川西','川東','川北','川南','川村','川本','川田','川野','川橋','川谷','川沢','川澤','川津','川越','川合','川路','川辺','川端','川浪','川棚',
    '菅田','菅野','菅川','菅村','菅本','菅原','菅島','菅崎','菅沢','菅澤','菅谷',
    '亀田','亀野','亀川','亀村','亀本','亀原','亀島','亀崎','亀井','亀山',
    '唐田','唐野','唐川','唐村','唐本','唐原','唐島','唐崎','唐沢','唐澤','唐津',
    '川棚','川俣','川俣','川浪','川浪',
    '勝田','勝野','勝川','勝村','勝本','勝原','勝島','勝崎','勝沢','勝澤',
    '片桐','片岡','片山','片野','片田','片川','片村','片本','片原','片島','片崎','片沢','片澤',
    '桂田','桂野','桂川','桂村','桂本','桂原','桂島','桂崎',
    '香田','香野','香川','香村','香本','香原','香島','香崎',
    '柏田','柏野','柏川','柏村','柏本','柏原','柏島','柏崎','柏沢','柏澤',
    '笠田','笠野','笠川','笠村','笠本','笠原','笠島','笠崎',
    '梶田','梶野','梶川','梶村','梶本','梶原','梶島','梶崎',
    '刈田','刈野','刈川','刈村',
    '木田','木野','木川','木村','木本','木原','木島','木崎','木沢','木澤','木津','木谷','木村','木内','木戸','木暮',
    '喜田','喜野','喜川','喜村','喜本','喜原','喜島','喜崎',
    '岸田','岸野','岸川','岸村','岸本','岸原','岸島','岸崎',
    // き行追加
    '北田','北野','北川','北村','北本','北原','北島','北崎','北沢','北澤','北谷','北山','北西','北東',
    '清田','清野','清川','清村','清本','清原','清島','清崎','清沢','清澤','清水','清家','清宮',
    '木暮','木佐','木村',
    '国田','国野','国川','国村','国本','国原','国島','国崎','国沢','国澤',
    '栗田','栗野','栗川','栗村','栗本','栗原','栗島','栗崎','栗沢','栗澤','栗山','栗林',
    '久田','久野','久川','久村','久本','久原','久島','久崎','久沢','久澤','久津','久谷','久保田','久保野',
    '桐田','桐野','桐川','桐村','桐本','桐原','桐島','桐崎',
    '衣田','衣野','衣川','衣村','衣本','衣原','衣島','衣崎',
    '貴田','貴野','貴川','貴村','貴本','貴原','貴島','貴崎',
    // く行追加
    '熊田','熊野','熊川','熊村','熊本','熊原','熊島','熊崎','熊沢','熊澤','熊谷','熊山',
    '黒田','黒野','黒川','黒村','黒本','黒原','黒島','黒崎','黒沢','黒澤','黒津','黒谷','黒山','黒木',
    '倉田','倉野','倉川','倉村','倉本','倉原','倉島','倉崎','倉沢','倉澤','倉谷','倉山',
    '桑田','桑野','桑川','桑村','桑本','桑原','桑島','桑崎',
    '国分','国見','国友',
    '工藤','工田','工野','工川',
    '久世','久慈','久喜',
    // け行追加
    ...
    '桁田','桁野',
    // こ行追加
    '小宮山','小早川','小次郎','小山田','小山内','小谷野',
    '古田','古野','古川','古村','古本','古原','古島','古崎','古沢','古澤','古谷','古山',
    '高田','高野','高川','高村','高本','高原','高島','高崎','高橋','高沢','高澤','高谷','高山','高木','高倉','高梨','高岡','高根','高坂',
    '腰田','腰野','腰川','腰村',
    '後藤','後田','後野','後川','後村','後本','後原','後島','後崎',
    '郡田','郡野','郡川','郡村','郡本','郡原',
    '小嶋','小嶋',
    // さ行追加
    '坂田','坂野','坂川','坂村','坂本','坂原','坂島','坂崎','坂沢','坂澤','坂谷','坂山','坂上','坂下','坂西','坂東',
    '佐伯','佐久間','佐々木','佐々田','佐々野',
    '斉藤','斎藤','齋藤','斉田','斉野','斉川','斉村',
    '柴田','柴野','柴川','柴村','柴本','柴原','柴島','柴崎',
    '島田','島野','島川','島村','島本','島原','島崎','島橋','島谷','島沢','島澤','島津',
    '下田','下野','下川','下村','下本','下原','下島','下崎','下沢','下澤','下谷','下山','下西','下東',
    '沢田','沢野','沢川','沢村','沢本','沢原','沢島','沢崎',
    '白田','白野','白川','白村','白本','白原','白島','白崎','白沢','白澤','白谷','白山',
    '杉田','杉野','杉川','杉村','杉本','杉原','杉島','杉崎','杉沢','杉澤','杉谷','杉山','杉浦','杉浜',
    '関田','関野','関川','関村','関本','関原','関島','関崎','関沢','関澤','関谷','関山',
    '瀬田','瀬野','瀬川','瀬村','瀬本','瀬原','瀬島','瀬崎','瀬沢','瀬澤','瀬谷',
    '曽田','曽野','曽川','曽村','曽本','曽原','曽島','曽崎','曽根',
    '新田','新野','新川','新村','新本','新原','新島','新崎','新沢','新澤','新谷','新山',
    '清水田','清水野',
    '佐土原','佐方','佐久',
    '三枝','三條','三鷹',
    '笹田','笹野','笹川','笹村','笹本','笹原','笹島','笹崎','笹沢','笹澤','笹谷','笹山',
    '鷺田','鷺野','鷺川','鷺村',
    '定田','定野','定川','定村','定本','定原',
    '實田','實野','實川','實村',
    // し行追加
    '宍田','宍野','宍川','宍村','宍戸','宍原',
    '塩田','塩野','塩川','塩村','塩本','塩原','塩島','塩崎','塩沢','塩澤','塩谷','塩山',
    '城田','城野','城川','城村','城本','城原','城島','城崎',
    '神田','神野','神川','神村','神本','神原','神島','神崎','神沢','神澤','神谷','神山',
    '白鳥','白兎',
    '志田','志野','志川','志村','志本','志原','志島','志崎',
    '芝田','芝野','芝川','芝村','芝本','芝原','芝島','芝崎',
    '七田','七野','七川','七村',
    '十田','十野','十川','十村',
    // す行追加
    '菅沼','菅井','菅生',
    '鈴木田','鈴木野',
    '鷹田','鷹野','鷹川','鷹村','鷹本','鷹原','鷹島','鷹崎',
    '炭田','炭野','炭川','炭村',
    '隅田','隅野','隅川','隅村','隅本','隅原',
    '住田','住野','住川','住村','住本','住原','住島',
    '周田','周野','周川','周村',
    // せ行追加
    '千田','千野','千川','千村','千本','千原','千島','千崎','千沢','千澤','千谷','千山','千葉','千賀',
    '仙田','仙野','仙川','仙村','仙本','仙原','仙島','仙崎',
    '専田','専野','専川','専村',
    '世田','世野','世川','世村',
    // そ行追加
    '曽我','曽我部','曽根田','曽根野',
    ...
    '空田','空野','空川','空村',
    // た行追加
    '高木','高見','高辺','高瀬','高須','高須賀','高嶋','高嶋','高間','高麗','高畠','高畑','高橋田','高橋野',
    '滝田','滝野','滝川','滝村','滝本','滝原','滝島','滝崎','滝沢','滝澤',
    '田島','田崎','田川','田村','田本','田原','田口','田中','田上','田下','田西','田東','田北','田南','田山','田谷','田沢','田澤','田津','田浦',
    '竹田','竹野','竹川','竹村','竹本','竹原','竹島','竹崎','竹沢','竹澤','竹谷','竹山','竹内','竹腰',
    '武田','武野','武川','武村','武本','武原','武島','武崎','武沢','武澤',
    '谷田','谷野','谷川','谷村','谷本','谷原','谷島','谷崎','谷沢','谷澤','谷山','谷口','谷上','谷下',
    '辻田','辻野','辻川','辻村','辻本','辻原','辻島','辻崎',
    '堤田','堤野','堤川','堤村','堤本','堤原','堤島','堤崎',
    '寺田','寺野','寺川','寺村','寺本','寺原','寺島','寺崎','寺沢','寺澤','寺谷','寺山',
    '豊田','豊野','豊川','豊村','豊本','豊原','豊島','豊崎','豊沢','豊澤',
    '富田','富野','富川','富村','富本','富原','富島','富崎','富沢','富澤','富山','富谷',
    '徳田','徳野','徳川','徳村','徳本','徳原','徳島','徳崎',
    '土田','土野','土川','土村','土本','土原','土島','土崎',
    '津田','津野','津川','津村','津本','津原','津島','津崎','津沢','津澤','津谷','津山',
    '多田','多野','多川','多村','多本','多原','多島','多崎','多沢','多澤',
    '立田','立野','立川','立村','立本','立原','立島','立崎',
    '種田','種野','種川','種村','種本','種原',
    '但田','但野','但川','但村',
    // ち行追加
    '千々岩','千々和',
    '中田','中野','中川','中村','中本','中原','中島','中崎','中沢','中澤','中谷','中山','中西','中東','中北','中南','中橋','中塚','中居',
    '茅田','茅野','茅川','茅村',
    // つ行追加
    '對馬','對田','對野',
    '筒田','筒野','筒川','筒村','筒本','筒原','筒井',
    '都田','都野','都川','都村','都本','都原','都島','都崎',
    '塚田','塚野','塚川','塚村','塚本','塚原','塚島','塚崎',
    // て行追加
    '出田','出野','出川','出村','出本','出原','出島','出崎',
    '天羽','天辻','天笠',
    '鉄田','鉄野','鉄川','鉄村',
    '寺尾','寺内','寺下','寺西',
    // と行追加
    '戸田','戸野','戸川','戸村','戸本','戸原','戸島','戸崎',
    '東田','東野','東川','東村','東本','東原','東島','東崎','東沢','東澤','東谷','東山',
    '登田','登野','登川','登村','登本','登原',
    '遠田','遠野','遠川','遠村',
    '冨田','冨野','冨川','冨村','冨本','冨原','冨島',
    '土橋','土屋','土谷','土肥',
    '外田','外野','外川','外村','外本','外原',
    '唐沢','唐澤','唐木',
    '利田','利野','利川','利村','利本','利原',
    // な行追加
    '長田','長野','長川','長村','長本','長原','長島','長崎','長沢','長澤','長谷','長山','長橋','長谷部','長谷川',
    '中尾','中込','中嶋','中澤','中嶌',
    '成田','成野','成川','成村','成本','成原','成島','成崎',
    '生田','生野','生川','生村','生本','生原','生島','生崎',
    '浪田','浪野','浪川','浪村','浪本','浪原',
    '名田','名野','名川','名村','名本','名原','名島','名崎',
    '梨田','梨野','梨川','梨村',
    '南田','南野','南川','南村','南本','南原','南島','南崎','南沢','南澤','南谷','南山',
    '西田','西野','西川','西村','西本','西原','西島','西崎','西沢','西澤','西谷','西山',
    '仁田','仁野','仁川','仁村','仁本','仁原',
    '根田','根野','根川','根村','根本','根原','根島','根崎',
    '能田','能野','能川','能村','能本','能原','能島','能崎',
    '野崎','野上','野下','野口','野田','野村','野川','野山','野本','野島','野津','野沢','野澤','野谷',
    // に行追加
    '仁科','仁礼',
    '新庄','新発田','新宮','新座','新居浜',
    '二宮','二階堂','二見','二木',
    ...
    '野間','野本','野瀬','野杁','野路',
    // は行追加
    '橋田','橋野','橋川','橋村','橋本','橋原','橋島','橋崎',
    '浜田','浜野','浜川','浜村','浜本','浜原','浜島','浜崎','浜沢','浜澤','浜谷','浜山',
    '林田','林野','林川','林村','林本','林原','林島','林崎',
    '原田','原野','原川','原村','原本','原島','原崎','原沢','原澤','原谷','原山',
    '花田','花野','花川','花村','花本','花原','花島','花崎',
    '波田','波野','波川','波村','波本','波原','波崎',
    '羽田','羽野','羽川','羽村','羽本','羽原','羽島','羽崎',
    '樋田','樋野','樋川','樋村','樋本','樋原','樋島','樋崎',
    '平田','平野','平川','平村','平本','平原','平島','平崎','平沢','平澤','平谷','平山',
    '堀田','堀野','堀川','堀村','堀本','堀原','堀島','堀崎','堀沢','堀澤',
    '本田','本野','本川','本村','本原','本島','本崎','本橋',
    '細田','細野','細川','細村','細本','細原','細島','細崎',
    '穂田','穂野','穂川','穂村','穂本','穂原',
    '保田','保野','保川','保村','保本','保原','保島','保崎',
    '帆田','帆野','帆川','帆村',
    '芳田','芳野','芳川','芳村','芳本','芳原',
    '星田','星野','星川','星村','星本','星原','星島','星崎',
    '坊田','坊野','坊川','坊村',
    '防田','防野','防川','防村',
    '鳳田','鳳野','鳳川','鳳村',
    '宝田','宝野','宝川','宝村','宝原','宝島',
    '北野','北田','北川','北村','北本','北原','北島','北崎',
    // ひ行追加
    '久田','久野','久川','久村',
    '姫田','姫野','姫川','姫村','姫本','姫原','姫島','姫崎',
    '比田','比野','比川','比村','比本','比原',
    '菱田','菱野','菱川','菱村','菱本','菱原',
    '日田','日野','日川','日村','日本','日原','日島','日崎',
    '引田','引野','引川','引村','引本','引原',
    '肥田','肥野','肥川','肥村','肥本','肥原',
    '開田','開野','開川','開村','開本','開原',
    // ふ行追加
    '深田','深野','深川','深村','深本','深原','深島','深崎','深沢','深澤',
    '福田','福野','福川','福村','福本','福原','福島','福崎','福沢','福澤','福谷','福山',
    '古田','古野','古川','古村','古本','古原','古島','古崎','古沢','古澤','古谷','古山',
    '船田','船野','船川','船村','船本','船原','船島','船崎',
    '富士田','富士野','富士川','富士村',
    '藤田','藤野','藤川','藤村','藤本','藤原','藤島','藤崎','藤沢','藤澤','藤谷','藤山',
    '二田','二野','二川','二村',
    '冬田','冬野','冬川','冬村',
    // へ行追加
    '別田','別野','別川','別村','別本','別原','別府',
    '辺田','辺野','辺川','辺村','辺本','辺原',
    '蛇田','蛇野','蛇川','蛇村',
    // ほ行追加
    '幌田','幌野','幌川','幌村',
    ...
    '北上','北下',
    // ま行追加
    '前田','前野','前川','前村','前本','前原','前島','前崎',
    '牧田','牧野','牧川','牧村','牧本','牧原','牧島','牧崎',
    '松田','松野','松川','松村','松本','松原','松島','松崎','松沢','松澤','松谷','松山','松尾','松浦',
    '丸田','丸野','丸川','丸村','丸本','丸原','丸島','丸崎',
    '三田','三野','三川','三村','三本','三原','三島','三崎',
    '宮田','宮野','宮川','宮村','宮本','宮原','宮島','宮崎','宮沢','宮澤','宮谷','宮山',
    '水田','水野','水川','水村','水本','水原','水島','水崎',
    '南田','南野','南川','南村','南本','南原',
    '見田','見野','見川','見村','見本','見原','見島','見崎',
    '三枝','三輪','三浦',
    '望田','望野','望川','望村','望本','望原',
    '盛田','盛野','盛川','盛村','盛本','盛原','盛島',
    '森田','森野','森川','森村','森本','森原','森島','森崎','森沢','森澤','森谷','森山',
    '物田','物野','物川','物村',
    '問田','問野','問川','問村',
    // み行追加
    '三好','三沢','三澤',
    '御子柴','御子田',
    '妙田','妙野','妙川','妙村',
    '道田','道野','道川','道村','道本','道原','道島','道崎',
    '南波','南保',
    '光田','光野','光川','光村','光本','光原','光島','光崎',
    // む行追加
    '武田','武野','武川','武村',
    '棟田','棟野','棟川','棟村',
    '村瀬','村越','村岡','村岸','村上','村下','村西','村東','村北','村南',
    '室田','室野','室川','室村','室本','室原','室島','室崎',
    '夢田','夢野','夢川','夢村',
    '麦田','麦野','麦川','麦村',
    // め行追加
    '目田','目野','目川','目村','目本','目原',
    '明田','明野','明川','明村','明本','明原',
    '馬田','馬野','馬川','馬村','馬本','馬原','馬島','馬崎',
    // も行追加
    '籾田','籾野','籾川','籾村',
    '桃田','桃野','桃川','桃村','桃本','桃原',
    '杜田','杜野','杜川','杜村',
    ...
    '本庄','本多','本間','本荘',
    // や行追加
    '安田','安野','安川','安村','安本','安原','安島','安崎',
    '谷口','谷上','谷下','谷内',
    '山口','山上','山下','山西','山東','山北','山南','山内','山中','山本','山田','山野','山川','山村','山原','山島','山崎','山沢','山澤','山谷',
    '柳田','柳野','柳川','柳村','柳本','柳原','柳島','柳崎','柳沢','柳澤',
    '矢田','矢野','矢川','矢村','矢本','矢原','矢島','矢崎','矢沢','矢澤',
    '薮田','薮野','薮川','薮村','薮本','薮原',
    '薮崎','藪田','藪野','藪川','藪村','藪本','藪原','藪崎',
    '屋田','屋野','屋川','屋村','屋本','屋原',
    '八田','八野','八川','八村','八本','八原','八島','八崎',
    '弥田','弥野','弥川','弥村','弥本','弥原',
    '横田','横野','横川','横村','横本','横原','横島','横崎','横沢','横澤','横谷','横山',
    '吉田','吉野','吉川','吉村','吉本','吉原','吉島','吉崎','吉沢','吉澤','吉谷','吉山',
    // ゆ行追加
    '湯田','湯野','湯川','湯村','湯本','湯原','湯島','湯崎',
    '弓田','弓野','弓川','弓村','弓本','弓原',
    '由田','由野','由川','由村','由本','由原',
    '雪田','雪野','雪川','雪村','雪本','雪原',
    '夕田','夕野','夕川','夕村',
    ...
    '浪速','浪花',
    // わ行追加
    '和田','和野','和川','和村','和本','和原','和島','和崎',
    '若田','若野','若川','若村','若本','若原','若島','若崎',
    '渡田','渡野','渡川','渡村','渡本','渡原','渡島','渡崎',
    '鷲田','鷲野','鷲川','鷲村','鷲本','鷲原','鷲島','鷲崎',
    '鰐田','鰐野','鰐川','鰐村',
    '湾田','湾野','湾川','湾村',
    // 3〜4文字苗字追加
    '上村田','上村野',
    ...
    '蚊田','蚊野','蚊川',
    '鵜田','鵜野','鵜川','鵜村',
    '篠田','篠野','篠川','篠村','篠本','篠原','篠島','篠崎','篠沢','篠澤',
    '宗田','宗野','宗川','宗村','宗本','宗原','宗島','宗崎',
    '喜多田','喜多野','喜多川','喜多村',
    '西条','西尾','西岡','西垣','西浦','西谷','西澤','西沢',
    '東条','東尾','東岡','東垣','東浦',
    '南条','南尾','南岡','南垣','南浦',
    '北条','北尾','北岡','北垣','北浦',
    '石動','石堂','石黒','石神','石附','石切',
    ...
    '川越','川合','川路','川辺','川端','川浪',
    '田端','田辺','田尻','田所','田添','田嶋',
    '山端','山辺','山尻','山所','山添','山嶋','山崎田',
    '水口','水尻','水所','水谷','水嶋',
    '竹腰','竹居','竹尾','竹内',
    '杉浦','杉居','杉尾','杉腰',
    '江波','江連','江頭','江幡','江守','江森','江見','江面',
    '小早川','小幡','小椋','小倉','小熊','小鹿',
    '大蔵','大串','大嶋','大嶌','大淵','大淵',
    '中條','中嶋','中嶌','中澤','中尾','中込',
    '三輪田','三輪野',
    ...
    '亀井','亀倉','亀岡',
    '梅沢','梅澤','梅津','梅谷','梅山','梅村',
    '桜田','桜野','桜川','桜村','桜本','桜原','桜島','桜崎',
    '椿田','椿野','椿川','椿村','椿本','椿原',
    '菊田','菊野','菊川','菊村','菊本','菊原','菊島','菊崎','菊沢','菊澤','菊谷','菊山',
    '藤本田','藤本野',
    '荻本','荻谷','荻山',
    '棚田','棚野','棚川','棚村','棚本','棚原','棚橋',
    '畠田','畠野','畠川','畠村','畠本','畠原','畠山',
    '畑田','畑野','畑川','畑村','畑本','畑原','畑山',
    '埼田','埼野','埼川','埼村',
    '圦田','圦野','圦川','圦村',
    '樋口','樋上','樋下','樋内',
    '門田','門野','門川','門村','門本','門原','門島','門崎',
    '関口','関上','関下','関内','関根',
    '坂口','坂上','坂下','坂内',
    '池口','池上','池下','池内',
    '谷口','谷上','谷下','谷内',
    ...
    '井口','井上','井下','井内',
    '芦口','芦上','芦下','芦内',
    '谷根','坂根','岡根','中根','山根','川根','野根','林根','原根','森根','水根','松根','竹根','石根',
    '門脇','坂脇','岡脇','中脇','山脇','川脇',
    '世古','世古田','世古野',
    '勢田','勢野','勢川','勢村',
    '其田','其野','其川','其村',
  ...
  // ===== 組み合わせ生成（プレフィックス × サフィックス）=====
  // 末尾要素（60種）
  const _S = ['田','野','川','村','本','原','島','崎','沢','澤','谷','山','橋','口','上','下','内','西','東','北','南','岡','坂','池','松','竹','石','林','森','水','津','浦','尾','根','瀬','渕','淵','塚','浜','濱','倉','木','井','江','宮','沼','見','前','中','道','辺','端','峰','峯','岸','蔵','堂','坊','越','路'];

  // 先頭1文字（300字）
  '阿愛青赤秋芦荒安飯石市伊糸入岩植宇内梅江榎遠大小岡荻奥帯加鹿金鎌河川菅亀片木清北栗久国熊黒倉桑古坂佐柴島下白杉関瀬高滝竹武谷辻堤寺豊富徳土津多中長南西野沼橋浜林原花羽平堀本前牧松丸三宮水森村矢山柳吉横若渡藤深福菊薮星春香笠梶宗桂桐錦唐立生名千和鬼御湯弓由雪鶴鷹蛇龍虎猪馬牛磯葦葉芳芹蕪茅棚柚椿柿桃楓檜柾梁門寺梨霞霧露霜雷雲霊嵐嶺峡峯谷渓溪滝湧湖湾沖潟湿沼泥砂礁岩崖崩壁垣柵棚棒格弦弧琴鈴鐘錠鍵錨鋼鉄銀銅金白黒赤青紫橙黄緑茶桃桜藤葵菫蓮菊薔薇牡丹芙蓉菜花若緑新旧古今東西南北上下左右前後内外明暗静動剛柔強弱勇智仁義礼信徳孝悌忠廉恥誠実清濁善悪正邪公私官民武文芸技道理法術式格型形模範例基幹枝葉核殻鞘蓋底縁端界域圏帯層段階順列組系族属種類群集団衆多少寡僅百千万億兆一二三四五六七八九十百千壱弐参'.split('').forEach(p => _S.forEach(s => { if (p !== s) list.push(p + s); }));

  // 先頭2文字（600パターン）
  ['海老','阿久','春日','飯田','石井','石黒','石神','岩崎','岩田','池田','池上','伊藤','今井','今村','井上','入江','上田','上野','上原','植田','内田','浦田','浦野','梅田','江藤','江口','遠藤','遠田','大石','大田','大野','大山','大橋','大沢','大澤','小田','小野','小山','小川','小島','小林','岡田','奥田','荻野','加藤','金田','金子','神田','神野','川島','川口','川上','川田','川野','川村','北田','北野','北川','北村','栗田','栗原','久田','久野','久保','黒田','黒野','黒川','桑田','桑原','古田','古野','古川','坂田','坂野','坂口','佐藤','佐野','柴田','柴野','島田','島野','杉田','杉野','杉本','杉原','高田','高野','高木','高橋','竹田','竹野','竹内','武田','武野','田中','田野','辻田','辻野','堤田','豊田','富田','中田','中野','中川','中村','長田','長野','長谷','成田','西田','西野','野田','野口','野村','浜田','浜野','林田','林野','原田','原野','花田','花野','平田','平野','堀田','堀野','本田','本野','前田','前野','牧田','牧野','松田','松野','松本','松原','丸田','三田','宮田','宮野','水田','水野','森田','森野','村田','村野','矢田','矢野','山田','山野','山本','山原','山川','山村','吉田','吉野','横田','横野','渡田','渡野','藤田','藤野','深田','深野','福田','福野','菊田','菊野','菅田','菅野','関田','関野','後藤','後田','鈴木','青木','中島','橋本','清水','斎藤','宮本','熊谷','鶴田','鷹田','鷺田','磯田','芳田','桜田','菊池','菊地','寺田','金子','石橋','土橋','木橋','川橋','山橋','野橋','林橋','森橋','水橋','竹橋','松橋','柳橋','梅橋','桜橋','花橋','春橋','秋橋','東橋','西橋','南橋','北橋','上橋','下橋','中橋','大橋','小橋','岡橋','坂橋','池橋','村橋','原橋','島橋','崎橋','谷橋','浦橋','根橋','瀬橋','塚橋','浜橋','倉橋','江橋','宮橋','石田','石野','石川','石村','石本','石原','石島','石崎','木田','木野','木川','木村','木本','木原','木島','木崎','林田','林野','林川','林村','林本','林原','森田','森野','森川','森村','森本','森原','山田','山野','山川','山村','山本','山原','川田','川野','川村','川本','川原','川島','川崎','田野','田川','田村','田本','田原','田島','田崎','野川','野村','野本','野原','野島','野崎','原田','原野','原川','原村','原本','原島','原崎','高田','高野','高川','高村','高本','高原','高島','高崎','松田','松野','松川','松村','松本','松原','松島','松崎','竹田','竹野','竹川','竹村','竹本','竹原','竹島','竹崎','梅田','梅野','梅川','梅村','梅本','梅原','梅島','梅崎','桜田','桜野','桜川','桜村','桜本','桜原','桜島','桜崎','菊田','菊野','菊川','菊村','菊本','菊原','菊島','菊崎','椿田','椿野','椿川','椿村','椿本','椿原','柿田','柿野','柿川','柿村','桃田','桃野','桃川','桃村','楓田','楓野','楓川','楓村','鶴田','鶴野','鶴川','鶴村','鶴本','鶴原','鶴島','鶴崎','鷹田','鷹野','鷹川','鷹村','鷹本','鷹原','鷲田','鷲野','鷲川','鷲村','鷺田','鷺野','鷺川','鷺村','燕田','燕野','燕川','燕村','亀田','亀野','亀川','亀村','蛇田','蛇野','蛇川','蛇村','龍田','龍野','龍川','龍村','龍本','龍原','虎田','虎野','虎川','虎村','猪田','猪野','猪川','猪村','馬田','馬野','馬川','馬村','牛田','牛野','牛川','牛村','鯉田','鯉野','鯉川','鯉村','鮎田','鮎野','鮎川','鮎村','磯田','磯野','磯川','磯村','磯本','磯原','磯島','磯崎','葦田','葦野','葦川','葦村','葦本','葦原','葉田','葉野','葉川','葉村','根田','根野','根川','根村','芳田','芳野','芳川','芳村','芹田','芹野','芹川','芹村','蕪田','蕪野','茅田','茅野','茅川','棚田','棚野','棚橋','棟田','棟野','棟川','柚田','柚野','柚川','椿田','椿野','椿川','柿田','柿野','柿川','桃田','桃野','桃川','楓田','楓野','楓川','桧田','桧野','桧川','檜田','檜野','檜川','熊田','熊野','熊川','熊村','熊本','熊原','黒田','黒野','黒川','黒村','黒木','宇田','宇野','宇川','宇村','鹿田','鹿野','鹿川','鹿村','虎田','虎野','虎川','馬場','馬渕','兎田','兎野','鯨田','鯨野','蟹田','蟹野','蛸田','蛸野','蝶田','蝶野','鳩田','鳩野','鴨田','鴨野','雀田','雀野','鷺田','鷺野','鷲田','鷲野','鵜田','鵜野','雉田','雉野','孔雀','白鳥','金剛','金峰','金剛','玉田','玉野','玉川','玉村','玉本','玉原','玉島','玉崎','宝田','宝野','宝川','宝村','宝本','宝原','宝島','珠田','珠野','珠川','珠村','珠本','珠原','瑠璃','珊瑚','翡翠','琥珀','水晶','白玉','黄金','白銀','星田','星野','星川','星村','星本','星原','星島','星崎','月田','月野','月川','月村','月本','月原','月島','月崎','日田','日野','日川','日村','日本','日原','日島','日崎','空田','空野','空川','空村','雲田','雲野','雲川','雲村','霧田','霧野','霧川','霧村','嵐田','嵐野','嵐川','嵐村','霜田','霜野','霜川','霜村','雷田','雷野','雷川','雷村','露田','露野','露川','露村','霞田','霞野','霞川','霞村','湖田','湖野','湖川','湖村','湖本','湖原','湖島','湾田','湾野','湾川','湾村','沖田','沖野','沖川','沖村','沖本','沖原','沖島','沖崎','浜辺','浜端','浜岸','浜蔵','砂田','砂野','砂川','砂村','砂本','砂原','砂島','砂崎','岩手','岩見','岩国','岩代','岩泉','岩舟','岩沼','岩槻'].forEach(p => _S.forEach(s => list.push(p + s)));

  // 先頭3文字（200パターン）
  ['海老根','海老沢','海老名','海老原','東海林','羽生田','羽生野','加賀美','加賀野','加賀田','加賀川','加賀村','佐久間','佐久田','佐久野','阿久津','阿久沢','阿久根','五十嵐','五十田','五十野','五十川','百々田','百々野','小田切','小田島','小田崎','小笹原','長谷部','長谷田','長谷野','長谷川','長谷村','春日田','春日野','春日川','春日村','春日本','春日原','東海田','東海野','東海川','宇都宮','東三河','西三河','四日市','九十九','八百屋','八十田','八十野','千代田','千代野','千代川','千代村','万代田','万代野','万代川','二ノ宮','一ノ瀬','一ノ田','一ノ野','二宮田','二宮野','三宮田','三宮野','四宮田','四宮野','五宮田','五宮野','喜多田','喜多野','喜多川','喜多村','古賀田','古賀野','古賀川','古賀村','伊賀田','伊賀野','伊賀川','伊賀村','甲賀田','甲賀野','甲賀川','甲賀村','加古田','加古野','加古川','加古村','武蔵田','武蔵野','武蔵川','武蔵村','相模田','相模野','相模川','相模村','伊勢田','伊勢野','伊勢川','伊勢村','尾張田','尾張野','尾張川','尾張村','近江田','近江野','近江川','近江村','丹後田','丹後野','丹後川','丹後村','丹波田','丹波野','丹波川','丹波村','但馬田','但馬野','但馬川','但馬村','播磨田','播磨野','播磨川','播磨村','淡路田','淡路野','淡路川','淡路村','備前田','備前野','備前川','備前村','備中田','備中野','備中川','備中村','備後田','備後野','備後川','備後村','安芸田','安芸野','安芸川','安芸村','長門田','長門野','長門川','長門村','周防田','周防野','周防川','周防村','豊前田','豊前野','豊前川','豊前村','豊後田','豊後野','豊後川','豊後村','肥前田','肥前野','肥前川','肥前村','肥後田','肥後野','肥後川','肥後村','薩摩田','薩摩野','薩摩川','薩摩村','大隅田','大隅野','大隅川','大隅村','日向田','日向野','日向川','日向村','壱岐田','壱岐野','壱岐川','壱岐村','対馬田','対馬野','対馬川','対馬村'].forEach(p => _S.forEach(s => list.push(p + s)));
